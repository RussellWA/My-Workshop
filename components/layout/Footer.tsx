...
export default function Footer() {
    return (
        <footer className="border-t border-zinc-800/70">
            <div className="mx-auto flex max-w-7xl flex-col items-center px-8 py-10 md:py-20">
                ...
                <Link
                    href="/"
                    className="text-md md:text-lg font-bold uppercase tracking-[0.35em] text-zinc-100"
                >
                    Arcane Workshop
                </Link>

                <div className="mt-10 flex flex-col items-center gap-1 text-xs md:text-sm text-zinc-500">
